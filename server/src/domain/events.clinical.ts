...
export const ClinicalEventType = {
  ...
  PROCEDURE_RECORDED: 'PROCEDURE_RECORDED',
  PROCEDURE_COMPLETED: 'PROCEDURE_COMPLETED',
  PROCEDURE_VOIDED: 'PROCEDURE_VOIDED',
  CARE_PLAN_CREATED: 'CARE_PLAN_CREATED',
  CARE_PLAN_STATUS_CHANGED: 'CARE_PLAN_STATUS_CHANGED',
  CARE_GOAL_ACHIEVED: 'CARE_GOAL_ACHIEVED',
  REFERRAL_SLA_BREACHED: 'REFERRAL_SLA_BREACHED',
