...
-- clinical notes, treatment responses, prescriptions, procedures and safety
-- overrides.
--
...
-- measurement is a new row (an amended re-reading), never an edit of the
-- original — the same append-only correction semantics the rest of the clinical
-- record already uses.
--
