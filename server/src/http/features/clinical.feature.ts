...
import { procedureRoutes } from '../routes/procedures.routes.js';
import { carePlanRoutes } from '../routes/care-plans.routes.js';
...
export async function clinicalFeature(app: FastifyInstance): Promise<void> {
  ...
  await app.register(procedureRoutes);
  await app.register(carePlanRoutes);
}
